...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "cards.context_processors.notifications",
            ],
        },
    },
]

WSGI_APPLICATION = "mongoats.wsgi.application"

# Falls back to local sqlite so `runserver` works before DATABASE_URL is set -
# useful as a first sanity check of your environment before the shared DB
...
AUTH_PASSWORD_VALIDATORS = []  # intentionally empty - hackathon, no real user base
...
STORAGES = {
    "default": {
        "BACKEND": "cards.supabase_storage.SupabaseStorage",
    },
    "staticfiles": {
